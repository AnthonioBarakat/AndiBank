...
def transactions(request, Id=-1):
    ...
    # POST
        ...
        try:
            User.objects.get(pk=request.data["r_SSN"])
            return Response({"success":"Transaction done successfuly", "is_ours":1}, status.HTTP_201_CREATED)
        
        except:
            return Response({"success":"Transaction done successfuly", "is_ours":0}, status.HTTP_201_CREATED)
